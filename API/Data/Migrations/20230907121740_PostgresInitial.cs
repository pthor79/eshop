            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BuyerId = table.Column<string>(type: "text", nullable: true),
                    ShipAddress_FullName = table.Column<string>(type: "text", nullable: true),
                    ShipAddress_AddressLine1 = table.Column<string>(type: "text", nullable: true),
                    ShipAddress_AddressLine2 = table.Column<string>(type: "text", nullable: true),
                    ...
                    ShipAddress_Country = table.Column<string>(type: "text", nullable: true),
